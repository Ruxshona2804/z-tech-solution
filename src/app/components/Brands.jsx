  ...
  return (
    <div className='container  h-[266px] flex flex-col justify-center items-center gap-10 ' >
        ...
        <div className='flex items-center justify-center gap-30'>
            <Image className='w-full h-[40px]' src={evernote} alt='brands' width={110} height={40} />
            <Image className='w-full h-[40px]' src={slack} alt='brands' width={110} height={40} />
            <Image className='w-full h-[40px]' src={intercom} alt='brands' width={110} height={40} />
            <Image className='w-full h-[40px]' src={airbnb} alt='brands' width={110} height={40} />
            <Image className='w-full h-[40px]' src={miro} alt='brands' width={110} height={40} />
            <Image className='w-full h-[40px]' src={uber} alt='brands' width={110} height={40} />
