    ...
    return (
        <div>
            <footer data-aos="fade-up"
                data-aos-duration="3000" className="md:bg-[#242B35] text-[#A8B3C4] md:h-[950px] md:py-16">
                <div className="container hidden md:block  h-[464px] space-y-12">
                    {/* Top section */}
                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
                        <div className="">
                            <Image src={logofooter} alt="Z Tech Solutions" width={200} height={36} />
                            <p className="mt-2 text-[16px] tracking-[0.3] ">
            ...
            <footer className="relative bg-[#242B35]  text-[#A8B3C4]   h-[668px] md:hidden">
                <div className="space-y-8 w-[90%] border-white">
                    {/* Top section */}
                    <div className="flex flex-col items-start gap-4">
                        <Image src={logofooter} alt="Z Tech Solutions" width={150} height={36} />
                    ...
                    <div className="flex justify-between">
                        <div>
                            <h4 className="text-white font-semibold mb-2 text-sm">Sections</h4>
                    ...
                    {/* Bottom section */}
                    <div className="border-t border-[#A8B3C4] pt-4 text-center text-sm">
                        <p className="mb-4">© Z Tech Solutions 2025, All Rights Reserved</p>
                        <div className="flex justify-center gap-4">
                            <Image src={xbutton} alt="X" width={36} height={36} className="rounded-md bg-white p-1" />
                            <Image src={linkedin} alt="LinkedIn" width={36} height={36} className="rounded-md bg-white p-1" />
                            <Image src={instagram} alt="Instagram" width={36} height={36} className="rounded-md bg-white p-1" />
                        </div>
                    </div>
                    <div className="absolute bottom-0 left-0 w-full h-[90px] bg-gradient-to-t from-white to-transparent"></div>
